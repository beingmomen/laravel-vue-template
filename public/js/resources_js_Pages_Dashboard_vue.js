...
//
//
var DashboardCard = function DashboardCard() {
  return Promise.resolve().then(function webpackMissingModule() { var e = new Error("Cannot find module '../components/DashboardCard.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; });
};
            ...
            _c(
              ...
              _vm._l(_vm.cards, function (card) {
                return _c(
                  ...
                  {
                    key: card.num,
                    staticClass: "card col-lg-3 mx-2 mt-2",
                    style: "border-left: 2px solid " + card.color,
                  },
                  [
                    _c("DashboardCard", {
                      attrs: { title: card.name, value: card.num },
                    }),
                  ],
                  1
                )
...
var staticRenderFns = [
  function () {
    ...
    return _c(
      ...
      [_c("h6", { staticClass: "card-title" }, [_vm._v("Main")])]
    )
  },
]
